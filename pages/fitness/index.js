                      ...
                      <>
                        {
                          <div className="rounded-md shadow">
                            <Link
                              ...
                              className="flex items-center justify-center px-8 py-3 border duration-150 border-transparent text-base font-medium rounded-md text-white bg-orange-500 hover:bg-orange-600 md:py-4 md:text-lg md:px-10"
                            >
                              Dashboard
                            </Link>
                          </div>
                        ...
                        <div className="sm:mt-0 sm:ml-3">
                          <a
                            href="#plans"
                            className="flex items-center justify-center px-8 py-3 duration-150 border border-transparent text-base font-medium rounded-md text-gray-800 bg-gray-200 hover:bg-gray-300 md:py-4 md:text-lg md:px-10"
                          >
                            Our Plans
                          </a>
                        </div>
          ...
          <div className="block lg:hidden lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <div className="w-full object-cover">
              <img
                ...
                src={"http://localhost:3001/static/media/yoga.5b79d528.jpg"}
                alt=""
              />
            </div>
          </div>
